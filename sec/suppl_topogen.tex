...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.6\linewidth]{figs/topogen/generation_time.pdf}
   \caption{\textbf{Generation time for different dataset sizes.} We report the time required to generate datasets of varying sizes using the DONUT framework. The results demonstrate that even large-scale variants remain practical in terms of generation time.}
...
\input{tables/donut-model-params.tex}
